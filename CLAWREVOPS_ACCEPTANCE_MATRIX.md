...
| Transactional email | Resend SMTP is configured with a sending-only key scoped to `notifications.myfbleads.com`; Twenty accepted a password-reset request and Resend recorded delivery to the owner address. |
